...
from cmdop_claude.sidecar.utils.exclusions import DirInfo, is_sensitive_content, is_sensitive_file, scan_project_dirs
from cmdop_claude.sidecar.utils.prompts import MAP_SYSTEM, MAP_USER
