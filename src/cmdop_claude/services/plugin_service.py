...
from ..models.mcp import MCPConfig, MCPServerCommand, MCPServerURL
...
class PluginService(BaseService):
    ...
    def __init__(self, config: Config) -> None:
        ...
        sidecar_dir = Path(self._config.claude_dir_path) / ".sidecar"
        sidecar_dir.mkdir(parents=True, exist_ok=True)
        self._cache_path = sidecar_dir / "plugins_cache.json"
